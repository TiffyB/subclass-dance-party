...
describe('bouncyDancer', function() {
  ...
  it('should have the class \'bouncyDancer\'', function() {
    expect(bouncyDancer.$node.hasClass('bouncyDancer'))
  });
  it('should have a \'line up\' function', function() {
    expect(bouncyDancer.lineUp).to.be.a.function;
  });
});
...
describe('shrinkyDancer', function() {
  ...
  it('should have the class \'shrinkyDancer\'', function() {
    expect(shrinkyDancer.$node.hasClass('shrinkyDancer'))
  });
  it('should have a \'line up\' function', function() {
    expect(shrinkyDancer.lineUp).to.be.a.function;
  });
});
/*
describe('shrinkyDancer', function() {
